...
**What a plugin was allowed is now recorded as the permissions you agreed to, not as five yes-or-no
flags.** The install dialog still asks the same questions; what changed is what the answers mean
afterwards.
...
installed later under the same id starts from nothing.
